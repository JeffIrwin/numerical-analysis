...
double precision function gauss7_single(f, xmin, xmax) result(area)
	...
	double precision, parameter :: x(*) = [ &
		 9.49107912342758524526189684047851262401d-1, &
		 7.41531185599394439863864773280788407074d-1, &
		 4.05845151377397166906606412076961463347d-1, &
		-9.49107912342758524526189684047851262401d-1, &
		-7.41531185599394439863864773280788407074d-1, &
		-4.05845151377397166906606412076961463347d-1, &
		 0.00000000000000000000000000000000000000d0   &
	]
	double precision, parameter :: w(*) = [ &
		1.29484966168869693270611432679082018329d-1, &
		2.79705391489276667901467771423779582487d-1, &
		3.81830050505118944950369775488975133878d-1, &
		1.29484966168869693270611432679082018329d-1, &
		2.79705391489276667901467771423779582487d-1, &
		3.81830050505118944950369775488975133878d-1, &
		4.17959183673469387755102040816326530612d-1  &
	]
...
double precision function kronrod15_single(f, xmin, xmax) result(area)
	...
	! Tables of abscissas and weights are taken from Jacob Williams' quadpack
	double precision, parameter :: x(*) = [ &
		 9.91455371120812639206854697526328516642d-1, &
		 9.49107912342758524526189684047851262401d-1, &
		 8.64864423359769072789712788640926201211d-1, &
		 7.41531185599394439863864773280788407074d-1, &
		 5.86087235467691130294144838258729598437d-1, &
		 4.05845151377397166906606412076961463347d-1, &
		 2.07784955007898467600689403773244913480d-1, &
		-9.91455371120812639206854697526328516642d-1, &
		-9.49107912342758524526189684047851262401d-1, &
		-8.64864423359769072789712788640926201211d-1, &
		-7.41531185599394439863864773280788407074d-1, &
	...
	double precision, parameter :: w(*) = [ &
		2.29353220105292249637320080589695919936d-2, &
		6.30920926299785532907006631892042866651d-2, &
		1.04790010322250183839876322541518017444d-1, &
		1.40653259715525918745189590510237920400d-1, &
		1.69004726639267902826583426598550284106d-1, &
		1.90350578064785409913256402421013682826d-1, &
		2.04432940075298892414161999234649084717d-1, &
		2.29353220105292249637320080589695919936d-2, &
		6.30920926299785532907006631892042866651d-2, &
		1.04790010322250183839876322541518017444d-1, &
		1.40653259715525918745189590510237920400d-1, &
		...
		1.90350578064785409913256402421013682826d-1, &
		2.04432940075298892414161999234649084717d-1, &
		2.09482141084727828012999174891714263698d-1  &
	]
