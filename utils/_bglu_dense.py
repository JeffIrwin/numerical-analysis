...
from scipy.linalg import (solve, lu_solve, lu_factor, solve_triangular,
                          LinAlgError)
#from scipy.linalg.cython_blas import daxpy, dswap
try:
...
#def swap_rows(self, double[:, ::1] H, int i) noexcept:
...
#def double row_subtract(self, double[:, ::1] H, int i):
...
#@cython.boundscheck(False)
#@cython.wraparound(False)
#def void hess_lu(self, double[:, ::1] H, int i, double[:,::1] ops):
...
#@cython.boundscheck(False)
#@cython.wraparound(False)
#def void perform_ops(self, double[::1] y, const double[:,::1] ops, bint rev = False):
...
class LU:
    ...
    #def public np.ndarray A
    #def public np.ndarray b
    #def public np.ndarray B
    #def public int m
    #def public int n
...
class BGLU(LU):
    ...
    #def public tuple plu
    #def public np.ndarray L
    #def public np.ndarray U
    #def public np.ndarray pi
    #def public np.ndarray pit
    #def public list ops_list
    #def public double bglu_time
    #def public int solves
    #def public int updates
    #def public int max_updates
    #def public list average_solve_times
    #def public bint mast
